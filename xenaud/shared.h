...
#define WRITE_PORT_UCHAR(x,y) xWRITE_PORT_UCHAR(x,y)
#define WRITE_PORT_USHORT(x,y) xWRITE_PORT_USHORT(x,y)
#define WRITE_PORT_ULONG(x,y) xWRITE_PORT_ULONG(x,y)
#define READ_PORT_UCHAR(x) xREAD_PORT_UCHAR(x)
#define READ_PORT_USHORT(x) xREAD_PORT_USHORT(x)
#define READ_PORT_ULONG(x) xREAD_PORT_ULONG(x)
#endif
